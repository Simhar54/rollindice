...
Création dun petit jeu sur navigateur web à l’aide du DOM.
...
- Cliquer sur loption "Hold", qui permet d’envoyer les points du ROUND vers le GLOBAL. Ce sera alors le
